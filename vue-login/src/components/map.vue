...
import { TileMapServiceImageryProvider, Viewer, buildModuleUrl, Cartesian3, Math as cesiumMath } from 'cesium'
...
<template>
  ...
  <el-button
    style="margin-top:25px;width: 50px;background-color: #66CC99;"
    @click="showpoint">查找</el-button>
</template>
